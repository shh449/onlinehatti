...
export default function CartPage() {
            ...
            if (item.product?._id === productId) {
                const currentStock =
                    item.selectedOptions?.size &&
                        item.product?.sizePricing
                        ? item.product.sizePricing.find(
                            (sp) =>
                                sp.size ===
                                item.selectedOptions.size
                        )?.stock || 0
    ...
    const getItemPrice = (item) => {
        ...
        if (
            ...
            const sizePriceObj =
                item.product.sizePricing.find(
                    (sp) =>
                        sp.size === item.selectedOptions.size
                );

            if (sizePriceObj) {
                price =
                    sizePriceObj.discountedPrice ||
                    sizePriceObj.price ||
                    price;
            }
        }
    ...
    const validateSelections = () => {
        for (const item of validCartItems) {
            // Color validation
            if (
                item.product?.availableColors?.length > 0 &&
                !item.selectedOptions?.color
            ) {
                showNotification(
                    `Please select color for ${item.product.name}`,
                    "error"
                );
            ...
            if (
                ...
                showNotification(
                    `Please select size for ${item.product.name}`,
                    "error"
                );
    ...
    const placeOrder = async () => {
        ...
        ["address", "city", "postalcode", "country", "contact"].forEach(
            (field) => {
        ...
        if (Object.keys(errors).length > 0) {
            return setAddressErrors(errors);
        }
                        ...
                        validCartItems.map((item) => {
                            ...
                            return (
                                <div
                                    ...
                                    className="flex flex-col p-4 rounded-3xl bg-white/20 backdrop-blur-lg text-white shadow-lg group overflow-hidden"
                                >
                                    {/* Product Image */}
                                    <img
                                        src={
                                        ...
                                        ?.length > 0 && (
                                            <div className="mt-3">
                                                ...
                                                <div className="flex flex-wrap gap-2">
                                                    {item.product.availableColors.map(
                                                        (
                                                            color
                                                        ) => (
                                                            <button
                                        ...
                                        ?.length > 0 && (
                                            <div className="mt-3">
                                                ...
                                                <div className="flex flex-wrap gap-2 max-w-full">
                                                    {item.product.availableSizes.map(
                                                        (
                                                            size
                                                        ) => (
                                                            <button
                                    ...
                                    {/* Price */}
                                    <div className="flex justify-between mt-4 font-semibold items-center gap-2">
                                        <span className="text-xl font-bold text-yellow-400">
                                            ...
                                            {itemPrice !==
                                                (item
                                                    ...
                                                    ?.price ||
                                                    0) && (
                                                    <span className="line-through text-sm text-gray-300 ml-1">
                                                        {
                                                            item
                                                                .product
                                                                ?.price
                                    ...
                                    <div className="flex justify-between mt-4 gap-2">
                                        ...
                                        <Button
                                            ...
                                            className="!bg-red-500 hover:!bg-red-600 !text-white !px-4 whitespace-nowrap"
                                        >
                                            Remove
                                        </Button>
                                    </div>
                ...
                <div className="w-full lg:w-96 p-4 rounded-3xl bg-white/20 backdrop-blur-lg shadow-lg flex flex-col gap-4 text-white">
                    ...
                    {validCartItems.map((item) => {
                        ...
                        return (
                            <div
                                key={item.product._id}
                                className="flex justify-between items-center p-2 rounded hover:bg-white/10 gap-2"
                            >
                    ...
                    <Button
                        ...
                        className="!bg-[#6b4f2c] hover:!bg-[#583e24] !w-full py-3 rounded text-lg font-semibold shadow-lg mt-2"
                    >
                        Checkout
                    </Button>
                </div>
            ...
            >
                ...
                >
                    ...
                    <Button
                        ...
                        className="!bg-gray-500 hover:!bg-gray-600 !w-full py-2 rounded text-lg font-semibold text-white mt-1"
                    >
                        Cancel
                    </Button>
                </Box>
